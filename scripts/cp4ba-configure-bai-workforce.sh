...
" > ${_BAI_WKF_TMP}
    ...
    if [[ ${_errorBuild} -eq 0 ]]; then
      log_info "${_CLR_GREEN}Creating BAI Workforce secret '${_CLR_YELLOW}${CP4BA_INST_BAI_BPC_WORKFORCE_SECRET}${_CLR_GREEN}' for bpmSystemId '${_CLR_YELLOW}${bpmSystemID}${_CLR_GREEN}'"
